...
| `make_artifacts.py` | 2→3 | **Colab GPU** | ✅ ada | Deteksi → SAM+adapter mask → render 3 arm (bbox/mask/hybrid) + manifest.jsonl. **TODO: rewire ke deteksi YOLO Stage 1 (bukan GT)** |
